        ...
        <div className="container mx-auto py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="inline-flex rounded-md shadow-sm" role="group">
              ...
              <button
                className="py-2 px-4 text-sm font-medium border focus:z-10 focus:ring-2 bg-gray-700 border-gray-600 text-white hover:text-white hover:bg-gray-600 focus:ring-blue-500 focus:text-white"
                onClick={showAddIconModal}
              >
              ...
              <button
                className="py-2 px-4 text-sm font-medium border focus:z-10 focus:ring-2 bg-gray-700 border-gray-600 text-white hover:text-white hover:bg-gray-600 focus:ring-blue-500 focus:text-white"
                onClick={() => dispatch({ type: 'REFRESH_ICONS' })}
              >
